...
tm_shape(all_rates) +
    tm_polygons("black_search_Iz",
        ...
        palette= "viridis",
        midpoint=NA,
        title="Local Moran's I, Black Search in London")
```
...
tm_shape(all_rates) +
    tm_polygons("white_search_Iz",
        ...
        midpoint=NA,
        title="Local Moran's I, White Search in London")
```
...
tm_shape(all_rates) +
    tm_polygons("asian_search_Iz",
        ...
        palette=MoranColours,
        midpoint=NA,
        title="Local Moran's I, Asian Search in London")
```
...
tm_shape(all_rates) +
    tm_polygons("black_hit_Iz",
        ...
        palette=MoranColours,
        midpoint=NA,
        title="Local Moran's I, Black Hit in London")
```
...
tm_shape(all_rates) +
    tm_polygons("white_hit_Iz",
        ...
        palette=MoranColours,
        midpoint=NA,
        title="Local Moran's I, White Hit in London")
```
...
tm_shape(all_rates) +
    tm_polygons("asian_hit_Iz",
        ...
        palette=MoranColours,
        midpoint=NA,
        title="Local Moran's I, Asian Hit in London")
```
...
We can see cluster 4 and 5 has very few observations so the density of clusters is very different.
...
df_cluster%>% 
  st_drop_geometry() %>% 
  group_by(cluster) %>% 
  #summarise(across(black_search_rate:na_hit_rate, median)) %>% 
