...
Build model only on S&S and crime rate (R2 = 0.565)
...
Add more variables to improve R-squ
...
Remove mean_income_rate and income_deprivation_rate to avoid Multicolinearity

```{r}
# build model 
model_final <- lm(search_log ~ crime_log  + median_income_rate
                + income_old_deprivation_rate   +  cars_rate,
                  data = regression_data2)
summary(model_final)
```
...
Moran's I index is 0.26, showing a moderate spatial autocorrelation on my multiple linear regression residuals. Check the quick plot
